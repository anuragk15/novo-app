...
import { Clock, FileText, Zap, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="rounded-xl w-full p-3 transition-all">
      ...
      <div className="flex flex-col space-y-3">
        <div className="group rounded-lg bg-background/50 p-2 transition-all hover:bg-background border border-border/50">
        ...
        <div className="group rounded-lg bg-background/50 p-2 transition-all hover:bg-background border border-border/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="rounded-full bg-yellow-500/10 p-2.5 transition-all group-hover:bg-yellow-500/20">
                <Lightbulb className="h-5 w-5 text-yellow-500" />
              </div>
              <p className="font-medium text-muted-foreground">Ideas Generated</p>
            </div>
            <h3 className="text-xl font-bold tracking-tight">
              {data?.usage?.ideasGenerated || "0"}
            </h3>
          </div>
        </div>
